...
export default function MapView({ waypoints, driverLocation, startLocation, height = '100%' }: MapViewProps) {
  ...
  // Live driver marker — independent from static layers
  useEffect(() => {
