...
https://maps.app.goo.gl/abc123`,
  ...
  page: {
    ...
    tapMap: 'Tap on the map',
    offRoute: 'You went off route — rerouting...',
    set: 'Set',
    useGps: 'Use GPS',
    end: 'End point',
  },
...
https://maps.app.goo.gl/abc123`,
  ...
  page: {
    ...
    tapMap: 'הקש על המפה',
    offRoute: 'סטית מהמסלול — מנתב מחדש...',
    set: 'אישור',
    useGps: 'השתמש ב-GPS',
    end: 'נקודת סיום',
  },
...
https://maps.app.goo.gl/abc123`,
  ...
  page: {
    ...
    tapMap: 'اضغط على الخريطة',
    offRoute: 'انحرفت عن المسار — إعادة التوجيه...',
    set: 'تعيين',
    useGps: 'استخدام GPS',
    end: 'نقطة النهاية',
  },
